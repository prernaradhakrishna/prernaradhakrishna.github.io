...
category: work
---
A priori power analysis for "Curiosity And Memory Under Cognitive Load: A Test Of Resource Boundaries And Prediction Error Effects". Simulation-based power analysis was conducted for H1, H2 and H7. Full preregistration including design parameters and model specification available at OSF (currently embargoed, will be publicly accessible upon publication).
